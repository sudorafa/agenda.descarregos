...
if ((!(Checkdate($data_descarrego1[1], $data_descarrego1[0], $data_descarrego1[2])))) {
    ...
    $query = "update agendadescarrego set nome_transportador = '$transp1', nome_fornecedor = '$fornec1', produto = '$produto1', qtd = '$qtd1', tipo_qtd = '$tipo_qtd1', data_agendamento = '$data', hora = '$hora', data_descarrego = '$data_descarrego1', nome_contato = '$nome1', telefone_contato = '$telefone1' where id = '$id3'";
